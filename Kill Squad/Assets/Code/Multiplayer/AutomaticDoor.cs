...
{
    [SerializeField] [SyncVar] private Transform door;
    [SerializeField] [SyncVar] private Transform closedPosition;
    [SerializeField] [SyncVar] private Transform openPosition;
    [SerializeField] [SyncVar] private Transform detectionPoint;
    ...
    {
        for (int i = 0; i < TurnTracker.instance.characters.Count; i++)
        {
