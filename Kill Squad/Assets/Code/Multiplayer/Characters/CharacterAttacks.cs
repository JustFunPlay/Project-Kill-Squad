...
{
    public SyncList<int> equipedWeapons = new SyncList<int>();
    ...
    [ClientRpc] protected override void SetEquipmentNames()
    {
        ...
        {
            equipmentSlots[i].text = charInfo.weaponOptions[equipedWeapons[i]].weaponName;
        }
    }
    [Server] protected override void OnSelectAction()
    {
        switch (selectedAction)
        {
            case Action.Action1:
                ...
                {
                    if (charInfo.weaponOptions[equipedWeapons[0]].type == WeaponType.Melee || charInfo.weaponOptions[equipedWeapons[0]].type == WeaponType.Heavy || charInfo.weaponOptions[equipedWeapons[0]].type == WeaponType.Swift)
                        GetMeleeVisuals(charInfo.weaponOptions[equipedWeapons[0]].range, true);
                    else
                        GetRangeVisuals(charInfo.weaponOptions[equipedWeapons[0]].range, true);
                }
                break;
            case Action.Action2:
                if (equipedWeapons.Count >= 2)
                {
                    if (charInfo.weaponOptions[equipedWeapons[1]].type == WeaponType.Melee || charInfo.weaponOptions[equipedWeapons[1]].type == WeaponType.Heavy || charInfo.weaponOptions[equipedWeapons[1]].type == WeaponType.Swift)
                        GetMeleeVisuals(charInfo.weaponOptions[equipedWeapons[1]].range, true);
                    else
                        GetRangeVisuals(charInfo.weaponOptions[equipedWeapons[1]].range, true);
                }
                break;
            case Action.Action3:
                if (equipedWeapons.Count >= 3)
                {
                    if (charInfo.weaponOptions[equipedWeapons[2]].type == WeaponType.Melee || charInfo.weaponOptions[equipedWeapons[2]].type == WeaponType.Heavy || charInfo.weaponOptions[equipedWeapons[2]].type == WeaponType.Swift)
                        GetMeleeVisuals(charInfo.weaponOptions[equipedWeapons[2]].range, true);
                    else
                    GetRangeVisuals(charInfo.weaponOptions[equipedWeapons[2]].range, true);
                }
                break;
            default:
                base.OnSelectAction();
